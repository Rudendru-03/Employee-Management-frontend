  ...
  if (employees.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow p-12 text-center">
        ...
        <h3 className="mt-2 text-lg font-medium text-gray-900">No employees</h3>
        <p className="mt-1 text-sm text-gray-500">No employees found. Create one to get started.</p>
      </div>
    );
  }
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {employees.map((employee) => (
              <tr key={employee._id} className="hover:bg-gray-50 transition">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-gray-600">{employee.userId?.email || 'N/A'}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-gray-900">{employee.department?.name || 'N/A'}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-gray-600">{employee.reportingManager?.email || 'N/A'}</div>
                </td>
              </tr>
            ))}
          </tbody>
